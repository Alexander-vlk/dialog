...
class DateFilterRequestSerializer(serializers.Serializer):
    ...
    date = serializers.DateField(help_text='Дата', format=DATE_FORMAT, required=False)
    ...
    def validate(self, attrs):
        ...
        if date and (date_start or date_end):
            raise serializers.ValidationError(
                'Должен быть либо передан один параметр date, либо оба параметра date_start, date_end, либо ни одного',
            )
