...
data_tracking_router.register(
    'lipid_profile', LipidProfileViewSet, basename='lipid_profile'
)
data_tracking_router.register(
    'microalbuminuria', MicroalbuminuriaViewSet, basename='microalbuminuria'
)
...
data_tracking_router.register(
    'physical_activity', PhysicalActivityViewSet, basename='physical_activity'
)
data_tracking_router.register('note', NoteViewSet, basename='note')
data_tracking_router.register(
    'mood_app_user', MoodAppUserViewSet, basename='mood_app_user'
)
