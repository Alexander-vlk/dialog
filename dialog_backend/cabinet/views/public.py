...
from cabinet.serializers import TreatmentTypeResponseSerializer, DiabetesTypeResponseSerializer
...
class DiabetesTypeAPIView(APIView):
    ...
    def get_queryset(self):
        ...
        if not diabetes_types:
            ...
            cache.set(self.diabetes_type_cache_key, diabetes_types, timeout=10000 if not settings.DEBUG else 10)
